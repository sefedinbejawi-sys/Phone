        ...
        <div className="relative h-52 sm:h-64 md:h-80 w-full overflow-hidden">
          ...
          <div className="absolute top-4 sm:top-6 left-4 sm:left-6 right-4 sm:right-6 flex items-center justify-between pointer-events-none">
            <div className="pointer-events-auto flex items-center gap-2">
              ...
              <span className="hidden sm:flex items-center gap-1.5 rounded-full border border-orange-500/30 bg-[#c2410c]/20 px-3 py-1.5 text-xs font-black text-orange-200 backdrop-blur-xl shadow-lg">
                <Star className="w-3.5 h-3.5 text-amber-400 fill-amber-400" />
                {language === 'ar' ? 'متجر معتمد زكليك - فرع 4' : 'Boutique Agréée ZKLIK - Branche 4'}
              </span>
            </div>
            ...
            <div className="pointer-events-auto flex items-center gap-2">
              <button
                ...
                className="grid h-10 w-10 place-items-center rounded-2xl border border-white/15 bg-black/50 text-white/85 backdrop-blur-xl transition hover:bg-[#c2410c]/30 hover:border-[#c2410c]/50 hover:text-white cursor-pointer shadow-lg"
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-5">
              ...
              <div className="relative">
                <div className="h-24 w-24 sm:h-32 sm:w-32 rounded-3xl border-2 border-orange-500/40 bg-[#0c0e17] p-2 shadow-[0_20px_50px_rgba(0,0,0,0.85)] backdrop-blur-2xl flex items-center justify-center group">
                  <img
                    src="/hamtine-logo.svg"
                    alt="شعار حمتين تيليكوم 4"
                    className="w-full h-full object-contain rounded-2xl drop-shadow-[0_4px_12px_rgba(194,65,12,0.4)] transition-transform duration-300 group-hover:scale-105"
                    referrerPolicy="no-referrer"
                  />
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2.5 flex-wrap">
                  <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
                    زكليك <span className="text-[#ea580c]">•</span> {t.storeName}
                  </h1>
                  <span className="inline-flex items-center gap-1 rounded-full border border-orange-500/40 bg-gradient-to-r from-[#ea580c]/30 to-[#c2410c]/30 px-3 py-0.5 text-xs font-black text-amber-300 shadow-sm">
