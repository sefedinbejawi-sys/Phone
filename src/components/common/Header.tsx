        ...
        <div className="flex items-center justify-between gap-4">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-lg sm:text-xl font-black tracking-tight text-white group-hover:text-[#f97316] transition">
                  زكليك <span className="text-[#ea580c] font-black">•</span> {t.storeName}
                </span>
                <span className="text-[10px] font-black px-2 py-0.5 rounded-full bg-gradient-to-r from-[#ea580c] to-[#c2410c] text-white shadow-sm border border-orange-400/30">
                  فرع 4
                </span>
              ...
              <p className="text-[11px] text-neutral-400 font-medium line-clamp-1">
                {language === 'ar' ? 'المتجر الإلكتروني الموثوق • توصيل لجميع الولايات' : 'Boutique certifiée • Livraison 58 Wilayas'}
              </p>
            </div>
          </div>
          ...
          >
            <input
              ...
              className="w-full bg-white/[0.04] text-white text-xs rounded-2xl pl-9 pr-4 py-2.5 border border-white/10 focus:outline-none focus:border-[#ea580c] focus:bg-white/[0.08] transition placeholder:text-neutral-500"
            />
            <button
              type="submit"
              className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-[#f97316] cursor-pointer"
          ...
          <nav className="flex items-center gap-1 sm:gap-2">
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-2xl text-xs sm:text-sm font-extrabold transition cursor-pointer ${
                currentView === 'storefront'
                  ? 'bg-[#c2410c] text-white shadow-[0_4px_20px_rgba(194,65,12,0.4)]'
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-2xl text-xs sm:text-sm font-extrabold transition cursor-pointer ${
                currentView === 'repairs'
                  ? 'bg-amber-500 text-[#08090d] shadow-[0_4px_20px_rgba(245,158,11,0.35)]'
                  : 'text-neutral-300 hover:text-white hover:bg-white/[0.06]'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-2xl text-xs sm:text-sm font-extrabold transition cursor-pointer ${
                currentView === 'installments'
                  ? 'bg-sky-500 text-white shadow-[0_4px_20px_rgba(14,165,233,0.35)]'
                  : 'text-neutral-300 hover:text-white hover:bg-white/[0.06]'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-2xl text-xs sm:text-sm font-extrabold transition cursor-pointer ${
                currentView === 'dashboard'
                  ? 'bg-purple-500 text-white shadow-[0_4px_20px_rgba(168,85,247,0.35)]'
                  : 'text-neutral-300 hover:text-white hover:bg-white/[0.06]'
              }`}
            >
            ...
            <button
              ...
              className="relative flex items-center justify-center p-2 sm:px-3.5 sm:py-2 rounded-2xl bg-gradient-to-r from-[#ea580c] to-[#c2410c] hover:from-[#f97316] hover:to-[#ea580c] text-white font-black transition cursor-pointer shadow-[0_4px_20px_rgba(194,65,12,0.35)] ml-1"
              title={t.cart}
            >
              ...
              {cartCount > 0 && (
                <span className="inline-flex items-center justify-center h-5 min-w-[20px] px-1 rounded-full bg-black text-amber-300 text-[11px] font-black mr-1">
                  {cartCount}
                </span>
              )}
            </button>
